            ...
            <div className="maintenance-scene">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
                    <g id="ocean">
                        ...
                        <path id="water" fill="url(#waterGradient)" d="M0 200.7h1000V354H0z" />
                    ...
                    <g id="tracks">
                        {Array.from({ length: 120 }).map((_, i) => {
                            const x = -10 + i * 10;
                            return <path key={i} className="st2" d={`M${x} 282.4h-3l-6.8 25.2h3z`} />;
                        })}
                    ...
                    <g id="train">
                        ...
                        <g id="wheels">
                            {[384.1, 416.1, 469.1, 734.1, 766.1, 821.1].map((cx) => (
                                <g key={cx}>
                                    <circle className="st6" cx={cx} cy="285.6" r="15.1" />
                                    <path
                                        className="st2"
                                        d={`M${cx} 295.7c-5.6 0-10.1-4.5-10.1-10.1s4.5-10.1 10.1-10.1 10.1 4.5 10.1 10.1c0 5.5-4.6 10.1-10.1 10.1z`}
                                    />
                                </g>
                            ))}
                        </g>
                        ...
                        <g id="car-layers">
                            ...
                            <g id="Text">
                                ...
                                />
                                <text
                                    transform="translate(655 214)"
                                    className="st8 st10 maintenance-label"
                                    fontSize="28"
                                >
                                    Maintenance
                                </text>
